import type { BlogContentData } from "@/components/BlogContent";

// Statically authored blog posts, keyed by slug. Shared by the blog detail
// page (rendering) and its layout (metadata + Article structured data).
export const BLOG_POSTS: Record<string, BlogContentData> = {
